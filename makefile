...
juliaInstall:
	julia -e 'using Pkg; Pkg.add("OrdinaryDiffEq"); Pkg.add("ReverseDiff"); Pkg.add("StatsFuns"); Pkg.add("DiffEqSensitivity"); Pkg.add("ProgressMeter"); Pkg.add("Optim"); Pkg.add("Zygote"); Pkg.add("PyCall")'
