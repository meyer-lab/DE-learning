...
juliaInstall:
	julia -e 'using Pkg; Pkg.add("OrdinaryDiffEq"); Pkg.add("LoopVectorization"); Pkg.add("DiffEqSensitivity"); Pkg.add("ProgressMeter"); Pkg.add("Optim"); Pkg.add("Zygote"); Pkg.add("PyCall")'
