...
def cluster_map():
    ...
    g = sns.clustermap(decreased_genes, cmap="bwr", col_cluster=False, method="centroid", xticklabels=True, center=0, cbar=True, z_score=1, figsize=(14, 20))
    ...
    g = sns.clustermap(decreased_perturbations, cmap="bwr", col_cluster=False, method="centroid", xticklabels=True, center=0, cbar=True, z_score=1, figsize=(14, 20))
