...
def cluster_map():
    ...
    g = sns.clustermap(decreased_genes, cmap="bwr", row_cluster=False, method="centroid", z_score=1, center=0, figsize=(14, 20))
    ...
    g = sns.clustermap(decreased_perturbations, cmap="bwr", row_cluster=False, z_score=1, method="centroid", center=0, figsize=(14, 20))
